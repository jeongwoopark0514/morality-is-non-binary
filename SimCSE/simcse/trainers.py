        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    # all_enc1 = self.model.encode(inputs["input_ids"][:, 0, :])
                    # all_enc2 = self.model.encode(inputs["input_ids"][:, 1, :])
                    # print(all_enc1, all_enc2)

                    # result = self.model.forward(**inputs).logits
                    # print(result.shape)
